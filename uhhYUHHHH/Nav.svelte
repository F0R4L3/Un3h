...
<style>
  ...
  #blinking-text {
  	animation: all blink 1s infinite;
  }
</style>
<header class="">
	<input type="checkbox" name="hbr" id="hbr" class="hbr peer" hidden aria-hidden="true">
	<nav class="fixed z-20 w-full bg-white/90 bg-gray-950 backdrop-blur navbar shadow-2xl shadow-gray-600/5 border-b border-gray-100 border-gray-800 peer-checked:navbar-active dark:shadow-none">
			...
			<div class="flex flex-wrap items-center justify-between gap-6 md:py-3 md:gap-0 lg:py-5">
				<div class="w-full items-center flex justify-between lg:w-auto">
					<a class="relative z-10" href="#" aria-label="logo">
						<h1 class="text-white text-3xl font-['Poppins'] ">Izablog<span class="text-sky-500" id="blinking-text">.netlify</span></h1>
					</a>
